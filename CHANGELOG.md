...
## Unreleased
- E: The .apkx link takes its name from the APK it points at, instead of composing it from the version file and possibly naming a build it does not contain.
